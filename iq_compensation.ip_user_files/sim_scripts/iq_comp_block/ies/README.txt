...
#
# Generated by export_simulation on Fri Oct 13 16:43:39 -0700 2017
#
################################################################################
...
'-reset_run' switch to the './iq_comp_block.sh' script.

./iq_comp_block.sh -reset_run
...
./iq_comp_block.sh -noclean_files

For more information on the script, please type './iq_comp_block.sh -help'.
